          ...
          <div>
            ...
            <div className={styles.container}>
              <p className={styles.about}>
                ...
                problems that we are faced with. But it can also serve as a
                source of truth. These words are as a reminder that ideas only
                useful when tempered through experience. I strive to write only
                about ideas which have been refined by contact with the real
                world. Creation as the pursuit of truth.
              </p>
              <p className={styles.about}>
              ...
              <p className={styles.about}>
                ...
                <a
                  href="https://twitter.com/davidsainez"
